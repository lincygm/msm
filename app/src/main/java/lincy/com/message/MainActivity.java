...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transaction.add(R.id.content_frame,orderFragment).
        add(R.id.content_frame,contentFragment)
                .show(contentFragment).hide(orderFragment).commit();
    ...
    private class DrawerItemClickListener implements ListView.OnItemClickListener {
        ...
        public void selectItem(int position){
            ...
            if(position == 0 ){
                getFragmentManager().beginTransaction().show(contentFragment).
                hide( orderFragment).commit();
                Toast.makeText(MainActivity.this,"aa",Toast.LENGTH_LONG).show();
            }else{
                Toast.makeText(MainActivity.this,"bb",Toast.LENGTH_LONG).show();

                getFragmentManager().beginTransaction().hide(contentFragment).show( orderFragment).commit();
            }
